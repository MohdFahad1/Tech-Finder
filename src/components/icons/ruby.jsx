...
export const RubyIcon  = ({ size }) => (
  ...
  >
    ...
    <path
      ...
      d="M29.519 29.521c17.882-17.73 40.937-28.207 49.785-19.28c8.843 8.926-.534 30.62-18.418 48.345c-17.884 17.725-40.653 28.779-49.493 19.852c-8.849-8.92.242-31.191 18.126-48.917"
    />
    <linearGradient
      id="deviconRuby9"
      x1="111.507"

...
export const SolidJSIcon  = ({ size }) => (
  ...
  >
    ...
    <path
      ...
      d="M104.654 65.91a36.226 36.226 0 0 0-38.641-12.076L16.1 69.934L0 98.111l90.164 15.295l16.1-28.981c3.22-5.635 2.415-12.075-1.61-18.516z"
    />
    <path

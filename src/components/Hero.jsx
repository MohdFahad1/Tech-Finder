  ...
  return (
    <>
      <div className="flex items-center justify-center ">
        <div className="flex flex-col items-center justify-center max-w-4xl px-5 mt-16 lg:px-0">
          <div className="mb-8 duration-300 hover:scale-105">
            <span className="relative inline-block overflow-hidden rounded-full p-[1px]">
              ...
              <div className="inline-flex items-center justify-center w-full h-full px-3 py-1 space-x-1 text-xs font-medium leading-5 bg-white rounded-full cursor-pointer group text-slate-600 backdrop-blur-xl dark:bg-black dark:text-slate-200">
                <Sparkle size={16} />
                <span>Introducing TechFinder</span>
              </div>
            </span>
          </div>
          ...
          <div>
            <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-gray-50 sm:text-6xl">
              ...
              <br /> in one place */}
              Your one-stop platform for exploring the latest{" "}
              <span className="text-[#3b82f6]">tech tools</span>.
            </h2>
            <p className="mt-4 leading-6 text-center text-gray-600 md:text-lg dark:text-gray-200 text-balance">
              Effortlessly find the perfect tools for your next project and{" "}
              <span className="opacity-70">save countless hours</span> of
              research.
            </p>
          </div>

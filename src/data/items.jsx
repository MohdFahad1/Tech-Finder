...
export const ITEMS = [
  {
    ...
    href: "/browse/web",
    icon: <Laptop className="w-6 h-6 mb-4 text-gray-900" />,
    description: "Building and maintaining websites and web applications.",
  },
  {
    title: "Mobile Development",
    href: "/browse/mobile",
    icon: <Smartphone className="w-6 h-6 mb-4 text-gray-900" />,
    description:
  ...
  },
  {
    ...
    icon: <MonitorSmartphone className="w-6 h-6 mb-4 text-gray-900" />,
    description:
  ...
  },
  {
    ...
    icon: <Monitor className="w-6 h-6 mb-4 text-gray-900" />,
    description:
  ...
  },
  {
    ...
    icon: <Gamepad2 className="w-6 h-6 mb-4 text-gray-900" />,
    description:
  ...
  },
  {
    ...
    icon: <Sparkle className="w-6 h-6 mb-4 text-gray-900" />,
    description:
